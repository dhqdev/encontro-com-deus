    ...
    () => {
      ...
      const build = () => {
        ...
        chars.forEach(ch => {
          ...
          const wrap = document.createElement('span') as HTMLElement;
          ...
          const inner = document.createElement('span') as HTMLElement;
      ...
      const inners = () =>
        wrappersRef.current
          .map(w => w.firstElementChild as HTMLElement)
          .filter(Boolean);
      ...
      // Declare with let so play and armHover can reference each other
      let armHover: () => void;
